...
public interface MyConstants {
    ...
    public static final String PHONE_RECORD_RESOURCE_NAME =  "phone";
    ...
    public static final String CUSTOMER_ADDRESS_RESOURCE_PATH =RESOURCE_PATH_ID_PATH + SLASH + CUSTOMER_ADDRESS_SUBRESOURCE_NAME;
    public static final String DONATION_RECORD_RESOURCE_PATH= "person"+"{personId}"+RESOURCE_PATH_ID_PATH + SLASH + DONATION_RECORD_RESOURCE_NAME ;
