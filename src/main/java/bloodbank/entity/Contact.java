...
@NamedQuery( name = Contact.FIND_SPECIFICCONTACT, query = "SELECT c FROM Contact c left join fetch c.owner left join fetch c.phone left join fetch c.address where c.address.id=:param1")

public class Contact extends PojoBaseCompositeKey< ContactPK> implements Serializable {
	private static final long serialVersionUID = 1L;
    public static final String FIND_SPECIFICCONTACT = "Contact.findByAddressID";
